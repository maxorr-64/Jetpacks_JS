class Player {
    ...
    handle_keydown(e) {
        ...
        if (key === this.controls.up) this.jet_acceleration = this.jet;
        if (key === this.controls.down) this.jet_acceleration = -this.jet;
    ...
    handle_keyup(e) {
        let key = e.key.toLowerCase();
        if (key === this.controls.left) this.x_velocity = 0;
        if (key === this.controls.right) this.x_velocity = 0;
        if (key === this.controls.up || key == this.controls.down) this.jet_acceleration = 0;
    }
    move(player) {
...
//# sourceMappingURL=index.080992b1.js.map
